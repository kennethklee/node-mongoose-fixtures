...
describe('Fixtures', function() {
    ...
    describe('with new mongoose instance', function() {
        var mongoose;
    ...
    describe('with global mongoose instance', function() {
        ...
        it('should not fail when calling reset() without parameters', function(done) {
            var model = mongoose.model('tests');
            model.create({
                name: 'test'
            }, function(err, doc) {
        ...
        it('should not fail when calling reset() with callback', function(done) {
            var model = mongoose.model('tests');
            model.create({
                name: 'test'
            }, function(err, doc) {
